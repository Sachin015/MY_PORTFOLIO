    ...
    <>
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-white">
          <strong className="">Sachin Mali - 2024</strong>
          <svg
            viewBox="0 0 2 2"
          ...
          Join Our Team – for Collab and Craft new Innovative ideas .
        </p>
        <a
          href="https://web.telegram.org"
          className="flex-none rounded-full bg-gradient-to-r from-purple-600 to-red-500 px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-900 hover:scale-90">
